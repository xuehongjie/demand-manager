<template>
  <div>
    <div class="wrapper">
      ...
      <el-table v-bind="table" :stripe="true" :data="tableData_" @selection-change="selectionChange" @sort-change="sortChange">
        <!-- 选择框 -->
        <el-table-column v-if="table.isSelect && table.isSelect === true && tableLabel && tableLabel.length > 0" type="selection"> </el-table-column>
